...
2. **Posizionamento:** Inserisci le cartelle con i file JSON nella cartella `/data` della root di questo progetto. Modifica il file 'config.py' inserendo la path corretta del tuo dataset.
